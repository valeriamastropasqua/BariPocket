...
export const MOCK_PLACES: Place[] = [
  {
    ...
    longDescription:
      'Uno dei punti più iconici di Bari: lampioni bianchi, mare, panchine. Ideale per una passeggiata serale, scattare foto e rilassarsi.',
    tags: ['tramonto', 'foto', 'passeggiata'],
    googleMapsUrl:
      'https://www.google.com/maps/search/?api=1&query=Lungomare+Nazario+Sauro+Bari',
    avgPriceLevel: 0,
    favorite: false,
  },
  {
    ...
    longDescription:
      'Piccolo panificio di quartiere dove trovare focaccia barese, panzerotti e prodotti da forno tipici.',
